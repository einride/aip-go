...
const file_einride_example_freight_v1_shipper_proto_rawDesc = "" +
	"\n" +
...
var (
	...
	file_einride_example_freight_v1_shipper_proto_rawDescData []byte
)
...
func file_einride_example_freight_v1_shipper_proto_rawDescGZIP() []byte {
	file_einride_example_freight_v1_shipper_proto_rawDescOnce.Do(func() {
		file_einride_example_freight_v1_shipper_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_einride_example_freight_v1_shipper_proto_rawDesc), len(file_einride_example_freight_v1_shipper_proto_rawDesc)))
	})
...
var file_einride_example_freight_v1_shipper_proto_goTypes = []any{
...
func file_einride_example_freight_v1_shipper_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_einride_example_freight_v1_shipper_proto_rawDesc), len(file_einride_example_freight_v1_shipper_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
