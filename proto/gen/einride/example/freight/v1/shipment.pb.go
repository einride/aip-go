...
func file_einride_example_freight_v1_shipment_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_einride_example_freight_v1_shipment_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_einride_example_freight_v1_shipment_proto_msgTypes[1].Exporter = func(v any, i int) any {
